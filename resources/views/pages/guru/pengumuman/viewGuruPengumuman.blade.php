...
@section('content')
    ...
    @include('pages.guru.pengumuman.pengumuman')
    @include('pages.guru.pengumuman.tipePengumuman')
    ...
    <script>
        ...
        $('body').on('click', '#tabPengumuman', function() {
            $('#tabViewPengumuman').removeClass('hidden')
            $('#tabPengumuman').addClass(isActive)
            $('#tabPengumuman').removeClass(isNotActive)
            
            $('#tabViewTipe').addClass('hidden')
        ...
        $('body').on('click', '#tabTipe', function() {
            $('#tabViewTipe').removeClass('hidden')
            $('#tabTipe').addClass(isActive)
            $('#tabTipe').removeClass(isNotActive)

            $('#tabViewPengumuman').addClass('hidden')
