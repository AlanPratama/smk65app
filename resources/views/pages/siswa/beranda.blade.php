...
--}}
    ...
    <div class="grid grid-cols-3 place-items-center gap-3 gap-y-6 px-3">
        <div class="sm:w-full sm:h-full w-16 h-16 py-2 flex flex-col justify-start items-center gap-1 mb-2 rounded">
            ...
            <h3 class="text-[12px] text-center">KELAS</h3>
        </div>
        <div class="sm:w-full sm:h-full w-16 h-16 py-2 flex flex-col justify-start items-center gap-1 mb-2 rounded">
            <img src="{{ asset('class-svgrepo-com.svg') }}" class="w-2/3 rounded-full shadow" alt="">
        ...
        <div class="sm:w-full sm:h-full w-16 h-16 py-2 flex flex-col justify-start items-center gap-1 mb-2 rounded">
            <img src="{{ asset('class-svgrepo-com.svg') }}" class="w-2/3 rounded-full shadow" alt="">
            <h3 class="text-[12px] text-center">ABSENSI</h3>
        </div>
        <div class="sm:w-full sm:h-full w-16 h-16 py-2 flex flex-col justify-start items-center gap-1 mb-2 rounded">
            <img src="{{ asset('class-svgrepo-com.svg') }}" class="w-2/3 rounded-full shadow" alt="">
            <h3 class="text-[12px] text-center">FORUM</h3>
        </div>
    </div>
...
<div id="default-carousel" class="relative w-full px-4 my-8" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden rounded-2xl md:h-80">
         <!-- Item 1 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('assets/homepageWall.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
        </div>
        <!-- Item 2 -->
        <div class="hidden duration-700 ease-in-out" data-carousel-item>
            <img src="{{ asset('assets/homepageWall.png') }}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
